...
:FoundIt
start /b /wait "" "%gameDir%\Warframe.exe" -silent -log:/Preprocessing.log -dx10:1 -threadedworker:0 -cluster:public -language:en -applet:/EE/Types/Framework/ContentUpdate
